...
|------------|-------------|--------|
| 2A202600486 Nguyễn Tiến Huy Hoàng | graph routing + docs + eval | 1,4 |
| 2A202600497 Trần Nhật Vĩ | retrieval/policy/synthesis worker wiring | 2,3 |
| 2A202600312 Trần Thanh Phong | MCP kiểm thử + validate traces | 3,4 |
| 2A202600064 Hoàng Đinh Duy Anh | Report tổng hợp + đối chiếu rubric | 4 |
