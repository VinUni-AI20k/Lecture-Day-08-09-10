...
```
Bạn là trợ lý nội bộ. Chỉ trả lời dựa trên context được cung cấp.
1. Trích dẫn nguồn cho mỗi thông tin sử dụng.
2. Nếu context không đủ → trả lời "Không đủ thông tin trong tài liệu nội bộ".
3. Không suy diễn ngoài context.
```
...
1. Giữ `(Không có context)` làm tín hiệu rõ ràng cho LLM
2. Bổ sung rule trong prompt để bắt buộc abstain: `Nếu context không đủ → "Không đủ thông tin trong tài liệu nội bộ"`
...
Nhóm phụ thuộc vào tôi ở phần output cuối — nếu synthesis sai, toàn bộ hệ thống sẽ trả lời sai.

**Phần tôi phụ thuộc vào thành viên khác:**
Ngược lại, tôi phụ thuộc vào Retrieval và Policy Worker để cung cấp context chính xác.
