...
Điểm tôi chưa tốt là chưa khóa triệt để các câu disambiguation (đặc biệt gq08) để đạt Full ổn định ở mọi lần chạy; vẫn còn phụ thuộc vào chất lượng retrieval của từng run.
...
Tôi sẽ tối ưu riêng case gq08 bằng cách thêm post-check trong synthesis cho câu dạng so sánh hai điều kiện HR: bắt buộc xác nhận đủ cả vế “nghỉ phép năm báo trước 3 ngày làm việc” và “nghỉ ốm trên 3 ngày cần giấy tờ y tế”. Tôi chọn việc này vì trace hiện tại cho thấy gq08 là câu còn rủi ro partial dù đa số câu khác đã ổn định.
