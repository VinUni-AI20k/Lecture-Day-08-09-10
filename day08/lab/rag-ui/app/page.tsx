    ...
    <main className="mx-auto flex max-w-2xl flex-1 flex-col justify-center gap-10 px-6 py-20">
      ...
      <div className="space-y-4">
        ...
        <p className="text-base text-muted-foreground leading-relaxed">
          Chat với tài liệu đã index; panel Inspector hiển thị từng bước
          retrieval, context được chọn, prompt gửi AI và telemetry (thời gian,
          chi phí ước lượng).
        </p>
      </div>
        ...
        {[
          {
            ...
            desc: "Chọn chế độ retrieval phù hợp với loại câu hỏi.",
          },
          {
            icon: Layers,
            title: "RAG Inspector",
            desc: "Xem từng bước pipeline — query → retrieve → rerank → answer.",
          },
          {
            icon: Zap,
            title: "Telemetry thực",
            desc: "Thời gian, token usage và chi phí ước tính mỗi lần gọi.",
          },
